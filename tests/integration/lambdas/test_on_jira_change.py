...
class test_lambda_gsbot_gs_jira(Test_Helper):
    ...
    def test_direct_invoke__issuelink_created(self):
        body = '{"timestamp":1580261639866,"webhookEvent":"issuelink_deleted","issueLink":{"id":11766,"sourceIssueId":10000,"destinationIssueId":10977,"issueLinkType":{"id":10028,"name":"Customer","outwardName":"is customer of","inwardName":"has customer","isSubTaskLinkType":false,"isSystemLinkType":false},"systemLink":false}}'
        payload = {'body': body}
