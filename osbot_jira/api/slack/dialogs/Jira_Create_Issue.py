...
class Jira_Create_Issue(API_Slack_Dialog):
    ...
    def setup(self):
        ...
        self.add_element_select  ("Issue Type", 'issue_type', [
                                                                ('Task','Task'),
                                                                ('Meeting','Meeting'),
                                                                ('Vulnerability','Vulnerability'),
                                                                ('Risk','Risk'),
                                                                ('Incident','Incident'),('Incident Task','Incident Task'),('Incident Fact','Incident Fact'),('IT Asset','IT Asset')], value=self.issue_type)
